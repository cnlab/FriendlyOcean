        ...
        <body>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <p>If you wish to use the surveys componenet, you will have to explicitly add it and any other components you want to use to the configuration. Adding only the "Survey" component will result in an app that only asks the survey questions you upload. We have a <a href="assets/friendly/surveys_template.json">template</a> and an <a href="assets/friendly/surveys_example.json">example</a> JSON file for you to look at. The example file contains two survey questions and the template conatins one question with extensive comments.</p> 
                    </div>
                </div>
